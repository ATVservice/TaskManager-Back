...
import { createTask, duplicateTask, getMoreDetails, getTaskById, getTasks } from '../controllers/taskController.js';
...
router.get('/getTaskById/:taskId',authMiddleware, asyncHandler(getTaskById));
